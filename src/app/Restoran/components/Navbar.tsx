...
export default function Navbar() {
  ...
  const titles: Record<string, string> = {
    ...
    '/Restoran/manajemenMeja': 'Manajemen Meja',
    '/Restoran/reservasi': 'Kelola Reservasi',
    '/Restoran/kelolaMenu': 'Kelola Menu',
    '/Restoran/pengaturan': 'Pengaturan',
    '/Restoran/ulasan': 'Ulasan',
    '/Restoran/logout': 'Logout',
  };
